...
class DBDAO 
{
    ...
    /**
     * Méthode qui permet de récupérer l'instance de la classe DBDAO.
     * @return DBDAO
     */
    public static function getInstance() : DBDAO
    {
        if (!isset(self::$instance) ){
            self::$instance = new DBDAO();
        }
