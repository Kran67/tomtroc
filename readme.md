...
- Importez le fichier sql/tomtroc.sql dans votre base de données.
...
Pour vous connecter en partie admin, le login est "Alice" et le mot de passe est "password" (attention aux majuscules)
